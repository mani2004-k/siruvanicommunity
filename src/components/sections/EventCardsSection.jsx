    ...
    <section className="py-20 md:py-28 bg-slate-900 text-white" id="events-cards">
      <div className="container-custom">
            ...
            {visibleCards.map((card, idx) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="text-slate-700 mb-6 text-sm leading-relaxed">{card.description}</p>
                  <Link
                    href={card.href}
        ...
        <div className="mt-16 ">
          ...
          <Link
            href="/join"
            className="inline-flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-slate-900 font-bold px-8 py-4 rounded-full shadow-xl transition-all duration-300 text-lg"
          >
