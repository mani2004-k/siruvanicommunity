    ...
    <section className="relative min-h-screen overflow-hidden text-white" id="hero">
      ...
      <div className="relative container-custom flex min-h-screen items-center py-24">
        <div className="max-w-3xl">
          ...
          <h1
            className="font-bold text-5xl sm:text-6xl lg:text-7xl leading-tight tracking-tight mb-8"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-4xl">
            {stats.map(({ icon: Icon, value, label }) => (
              <div
                key={label}
                className="bg-white/10 border border-white/15 rounded-3xl p-6 backdrop-blur-xl shadow-xl shadow-black/10"
              >
