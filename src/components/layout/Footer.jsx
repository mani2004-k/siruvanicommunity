...
const socialLinks = [
  ...
  { icon: Mail, href: "mailto:siruvani.ch@gmail.com", label: "Email" },
      ...
      <div className="container-custom py-14">
        <div className="max-w-4xl mx-auto text-center mb-12">
          <p className="text-3xl md:text-4xl font-semibold">
            Bringing Coimbatore to Chennai since 2012
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-300">
              ...
              <li>
                <a
                  href="mailto:siruvani.ch@gmail.com"
      ...
      <div className="border-t border-white/10">
        <div className="container-custom py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-sm text-slate-400">
            © {new Date().getFullYear()} Siruvani Foundation. All rights reserved.
          </p>
          <a
            href="#top"
            className="inline-flex items-center justify-center h-11 w-11 rounded-full bg-white/10 text-white hover:bg-accent transition-colors duration-200"
          >
