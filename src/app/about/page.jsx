...
const team = [
  {
    ...
    role: "President",
    avatarImage: "/images/about-member1.webp",
    desc: "Leading with vision for 5+ years",
  },
  {
    name: "Suresh Babu R.",
    role: "Secretary",
    avatarImage: "/images/about-member2.webp",
    desc: "Organizing community since 2016",
  },
  {
    name: "Meenakshi A.",
    role: "Treasurer",
    avatarImage: "/images/about-member3.webp",
    desc: "Managing funds with transparency",
  },
  {
    name: "Rajan P.",
    role: "Cultural Head",
    avatarImage: "/images/about-member4.webp",
    desc: "Keeping our traditions alive",
  },
  {
    name: "Priya K.",
    role: "Social Media",
    avatarImage: "/images/murali-mahadevan.webp",
    desc: "Connecting the community online",
  },
  {
    name: "Arumugam S.",
    role: "Events Coordinator",
    avatarImage: "/images/venkatesh.webp",
    desc: "Making every event memorable",
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-24 pb-20 bg-slate-950 overflow-hidden">
        ...
        <div className="container-custom relative text-center">
          <span className="inline-block bg-slate-800/60 border border-slate-700 text-slate-200 text-xs font-semibold px-4 py-2 rounded-full mb-5">
            About Us
          </span>
          <h1
      ...
      <section className="py-20 bg-sky-100">
        <div className="container-custom">
          <img
            ...
            className="mx-auto rounded-2xl shadow-lg mt-6 w-full max-w-3xl object-cover"
          />

          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] items-center">
            <div className="space-y-6 text-slate-900">
              <p className="text-lg leading-relaxed max-w-2xl">
                Siruvani was born in 2012 to unite Coimbatorians living in Chennai. It aimed to
                bring together families sharing a common heritage and create a supportive community
                far from home. During the devastating 2015-16 Chennai floods, Siruvani made a
                substantial impact. When a few Coimbatorian families came together to provide relief
                and support, they discovered something beautiful: the power of community.
              </p>
              <p className="text-lg leading-relaxed max-w-2xl">
                What began as an emergency response evolved into something much deeper - a bonded
                family of families who celebrate together, support each other, and preserve the rich
                cultural heritage of Coimbatore while embracing their new life in Chennai.
              </p>
              <p className="text-lg leading-relaxed max-w-2xl">
                Today, Siruvani Foundation is a thriving community of 500+ families across Chennai,
                united by shared roots, mutual support, and the joy of celebrating our Coimbatorian
                identity together. Our journey from crisis to community is a testament to the
                strength of togetherness and the enduring spirit of our people.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] mb-16">
            ...
            <div className="space-y-8">
              <div className="bg-primary-50 rounded-2xl p-8 border border-primary-100">
                ...
                <h3
                  className="text-xl font-bold text-primary-700 mb-6"
                  style={{ fontFamily: "Georgia, serif" }}
                >
                  Our Mission
                </h3>
                <p className="text-slate-600 leading-relaxed">
                  To create a vibrant, inclusive community for Coimbatorian families in Chennai —
                  fostering cultural pride, social connections, and collective welfare through
                  meaningful events and service initiatives.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="max-w-3xl mx-auto text-slate-200 text-lg leading-relaxed">
              A thriving community that bridges the gap between our CNET (Coimbatore, Nilgiris,
              Erode and Tiruppur) heritage and Chennai life.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-[32px] bg-slate-900/80 border border-white/10 p-6 shadow-xl backdrop-blur-sm">
              <img
                src="/images/about-feature1.webp"
                alt="A Network of Families"
                className="w-full h-52 rounded-3xl object-cover mb-5"
              />
            ...
            <div className="rounded-[32px] bg-slate-900/80 border border-white/10 p-6 shadow-xl backdrop-blur-sm">
              <img
                src="/images/about-feature2.webp"
                alt="Cultural Exchange Platform"
                className="w-full h-52 rounded-3xl object-cover mb-5"
              />
            ...
            <div className="rounded-[32px] bg-slate-900/80 border border-white/10 p-6 shadow-xl backdrop-blur-sm">
              <img
                src="/images/about-feature3.webp"
                alt="Support System"
                className="w-full h-52 rounded-3xl object-cover mb-5"
              />
            ...
            <div className="rounded-[32px] bg-slate-900/80 border border-white/10 p-6 shadow-xl backdrop-blur-sm">
              <img
                src="/images/about-feature4.webp"
                alt="Youth Engagement Space"
                className="w-full h-52 rounded-3xl object-cover mb-5"
              />
        ...
        <div className="container-custom">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] items-center">
            <div className="max-w-xl">
              ...
              <p className="text-slate-600 leading-relaxed">
                These numbers reflect the strength, service and spirit of the Siruvani community
                today.
              </p>
            </div>
                ...
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-slate-100">
                      Successful breakfast meets organized
                    </p>
                  </div>
                  <div className="opacity-20 text-6xl">✓</div>
                </div>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="section-subtitle">
              Dedicated volunteers who give their time and heart to serve our community.
            </p>
          </div>
