...
const EMAILJS_TEMPLATE_ADMIN =
  process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ADMIN || "YOUR_EMAILJS_TEMPLATE_ADMIN_ID";
const EMAILJS_TEMPLATE_APPLICANT =
  process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_APPLICANT || "YOUR_EMAILJS_TEMPLATE_APPLICANT_ID";
        ...
        <div className="container-custom mx-auto px-4">
          <div className="max-w-xl mx-auto text-center bg-slate-900/90 border border-white/10 rounded-[32px] p-10 shadow-2xl">
            ...
            <p className="text-slate-300 mb-8">
              Thank you for applying to Siruvani Foundation. We will review your details and contact
            ...
            <div className="rounded-3xl border border-white/10 bg-slate-900/80 p-6 mb-8 text-left text-slate-300 space-y-3">
              <p>
                <span className="font-semibold text-white">Name:</span> {form.firstName}{" "}
                {form.lastName}
              </p>
              <p>
                <span className="font-semibold text-white">Email:</span> {form.email}
              </p>
              <p>
                <span className="font-semibold text-white">Phone:</span> {form.phone}
              </p>
              <p>
                <span className="font-semibold text-white">How did you hear about us:</span>{" "}
                {form.hearAbout || "Not specified"}
              </p>
            </div>
            <button
              onClick={() => {
        ...
        <div className="container-custom relative z-10 px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto max-w-2xl text-slate-300 text-base md:text-lg leading-relaxed">
              Join our vibrant community and be part of something extraordinary. Fill out the form
              below to begin your journey with Siruvani Foundation.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="p-10">
              <form id="membership-form" onSubmit={handleSubmit} className="space-y-8">
                <section className="rounded-[28px] border border-white/10 bg-white/5 p-6">
                  ...
                  <div>
                    <label className="form-label">
                      Upload Photo <span className="text-slate-400 text-xs">(Optional)</span>
                    </label>
                ...
                <section className="rounded-[28px] border border-white/10 bg-white/5 p-6">
                  ...
                  <div>
                    <label className="form-label">
                      Other organizations that you are presently associated with along with position
                      held
                    </label>
                    <textarea
                ...
                <section className="rounded-[28px] border border-white/10 bg-white/5 p-6">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div>
                      <label className="form-label">
                        Please share reference of existing Siruvani Member, if any
                      </label>
                      <input
                    ...
                    <div>
                      <label className="form-label">
                        How did you come to know about Siruvani Foundation ? *
                      </label>
                      <select
                        name="hearAbout"
