            ...
            {contactInfo.map(({ icon: Icon, title, lines }) => (
              ...
              >
                ...
                {lines.map((line, i) => (
                  <p
                    key={i}
                    className={`text-xs ${i === 0 ? "text-slate-700 font-medium" : "text-slate-500"}`}
                  >
                    {line}
                  </p>
                ))}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              {sent ? (
                ...
                <form
                  ...
                  className="space-y-5 bg-white rounded-2xl shadow-sm border border-slate-200 p-8"
                >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-primary-50 rounded-2xl border border-primary-100 p-6">
                <h4 className="font-bold text-primary-700 mb-3 text-sm">
