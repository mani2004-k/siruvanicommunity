      ...
      <section className="relative overflow-hidden pb-16 pt-24 bg-white">
        ...
        <div className="container-custom relative z-10 px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-semibold leading-tight mb-6 text-slate-950">
              Become a Part of Siruvani Foundation
            </h1>
            <p className="mx-auto max-w-2xl text-slate-600 text-base md:text-lg leading-relaxed">
              Join a thriving Chennai community of CNET families, professionals and performers.
              Discover the benefits of membership, upcoming events and how to apply.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container-custom px-4 pb-20">
        <div className="mx-auto grid gap-8 lg:grid-cols-[1fr_420px] items-center">
          <div className="space-y-6">
            <p className="mb-4 text-sm uppercase tracking-[0.35em] text-cyan-700">
              Why Join Siruvani?
            </p>
            <div className="space-y-4 text-slate-700">
              <p className="flex items-start gap-3">
                <span className="mt-1 text-cyan-700">→</span>Celebrate your CNET heritage in Chennai
              </p>
              <p className="flex items-start gap-3">
                <span className="mt-1 text-cyan-700">→</span>Connect with like-minded families
                sharing similar values
              </p>
              <p className="flex items-start gap-3">
                <span className="mt-1 text-cyan-700">→</span>Access to diverse events and programs
              </p>
              <p className="flex items-start gap-3">
                <span className="mt-1 text-cyan-700">→</span>Families to learn, perform and grow
              </p>
              <p className="flex items-start gap-3">
                <span className="mt-1 text-cyan-700">→</span>Network with professionals from various
                industries
              </p>
              <p className="flex items-start gap-3">
                <span className="mt-1 text-cyan-700">→</span>Reliable community during personal or
                professional needs
              </p>
              <p className="flex items-start gap-3">
                <span className="mt-1 text-cyan-700">→</span>Make a meaningful impact through
                community initiatives
              </p>
            </div>
            <a
              href="/join"
              className="inline-flex items-center gap-2 rounded-full bg-cyan-900 px-8 py-3 text-white font-semibold shadow-xl shadow-cyan-200/30 hover:bg-cyan-800 transition"
            >
          ...
          <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-slate-50 p-1 shadow-sm">
            <img
              src="/images/membership-membership-whyjoin.webp"
              alt="Why join Siruvani"
        ...
        <div className="mx-auto grid gap-8 lg:grid-cols-[1fr_420px] items-center">
          <div className="space-y-6">
            ...
            <p className="text-slate-700 leading-relaxed">
              Siruvani welcomes all families with connections to CNET regions (Coimbatore, Nilgiris,
              Erode and Tiruppur) - whether you were born there, lived there, worked there, or
              simply love our culture. What matters is your heart for community and willingness to
          ...
          <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-slate-50 p-1 shadow-sm">
            <img
              src="/images/membership-membership-benefits.webp"
              alt="Who can join"
              className="h-full w-full object-cover rounded-[26px]"
            />
          </div>
      ...
      <section className="container-custom px-4 pb-20">
        <div className="mx-auto max-w-6xl space-y-10">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-[28px] bg-sky-100 p-8 text-slate-950 shadow-sm">
              ...
              <p className="mt-3 text-slate-700">
                Complete online membership form with family details.
              </p>
            </div>
            <div className="rounded-[28px] bg-sky-100 p-8 text-slate-950 shadow-sm">
              ...
              <p className="mt-3 text-slate-700">
                Members will validate your application and approve.
              </p>
            </div>
            <div className="rounded-[28px] bg-sky-100 p-8 text-slate-950 shadow-sm">
              ...
              <p className="mt-3 text-slate-700">
                Attend your first community event as a new member.
              </p>
            </div>
          </div>
          ...
          <div className="text-center">
            <a
              href="/join"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-cyan-900 px-8 py-4 text-white text-sm font-semibold shadow-xl shadow-cyan-200/30 hover:bg-cyan-800 transition"
            >
      ...
      <section className="container-custom px-4 pb-24">
        <div className="mx-auto max-w-6xl rounded-[32px] border border-slate-200 bg-slate-50 shadow-sm p-10">
          ...
          <p className="text-slate-600 leading-relaxed mb-6">
            Siruvani membership is designed for families and individuals who want to engage with our
            cultural events, workshops, and professional network. Members benefit from exclusive
            gatherings, learning sessions, and a supportive community of peers.
          </p>
